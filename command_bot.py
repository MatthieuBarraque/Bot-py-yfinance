...
async def orange(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Orange", description=f"La Valeurs Actuelle de Orange est de: **{stock_value} $**", color=discord.Color.orange())
...
async def airbus(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Airbus", description=f"La Valeurs Actuelle de Airbus est de: **{stock_value} $**", color=discord.Color.blue())
...
async def peugeot(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Peugeot", description=f"La Valeurs Actuelle de Peugeot est de: **{stock_value} $**", color=discord.Color.grey())
...
async def renault(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Renault", description=f"La Valeurs Actuelle de Renault est de: **{stock_value} $**", color=discord.Color.grey())
...
async def societe_generale(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Societe Generale", description=f"La Valeurs Actuelle de Societe Generale est de: **{stock_value} $**", color=discord.Color.red())
...
async def bnp_paribas(ctx):
    try :
        ...
        embed = discord.Embed(title="Action BNP Paribas", description=f"La Valeurs Actuelle de BNP Paribas est de: **{stock_value} $**", color=discord.Color.green())
...
async def credit_agricole(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Credit Agricole", description=f"La Valeurs Actuelle de Credit Agricole est de: **{stock_value} $**", color=discord.Color.green())
...
async def engie(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Engie", description=f"La Valeurs Actuelle de Engie est de: **{stock_value} $**", color=discord.Color.blue())
...
async def total(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Total", description=f"La Valeurs Actuelle de Total est de: **{stock_value} $**", color=discord.Color.orange())
...
async def sanofi(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Sanofi", description=f"La Valeurs Actuelle de Sanofi est de: **{stock_value} $**", color=discord.Color.blue())
...
async def vinci(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Vinci", description=f"La Valeurs Actuelle de Vinci est de: **{stock_value} $**", color=discord.Color.blue())
...
async def bouygues(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Bouygues", description=f"La Valeurs Actuelle de Bouygues est de: **{stock_value} $**", color=discord.Color.blue())
...
async def atos(ctx):
    try :
        ...
        embed = discord.Embed(title="Action Atos", description=f"La Valeurs Actuelle de Atos est de: **{stock_value} $**", color=discord.Color.blue())
